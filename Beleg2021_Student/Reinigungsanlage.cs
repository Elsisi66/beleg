...
namespace Beleg2021
{
    ...
    public class Reinigungsanlage
    {
        ...
        private static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("Ihr Code ist noch zu unvollständig oder es sind noch Ausnahmen enthalten, um sinnvoll gestartet zu werden.");
                Console.WriteLine("Die Nachricht der Exception war: " + ex.GetBaseException().GetType().ToString() + " --> " + ex.GetBaseException().Message);
            }
            finally { Console.ReadKey(); }
            //Hier passiert nichts, die Zeile sorgt nur dafür, dass sich die Konsole nicht direkt schließt
